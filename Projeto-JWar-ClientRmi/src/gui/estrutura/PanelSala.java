...
//        lbNomeSala.setBackground(Color.BLUE);
        lbNomeSala.setText(nome);
        gridBagConstraints = new java.awt.GridBagConstraints();
//        gridBagConstraints.fill = GridBagConstraints.VERTICAL;
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(0, 1, 3, 8);
    ...
    private void setSelectedSala() {
    	this.panelNumJog.setBackground(Color.BLUE);
//    	this.lbNomeSala.setOpaque(true);
    	this.updateUI();
    }
    ...
    public void desSelected() {
    	switch(state) {
    	case STATE_ABERTO:
    		this.panelNumJog.setBackground(new java.awt.Color(0, 102, 51)); break;
    	case STATE_COM_SENHA:
    		break;
    	case STATE_DUELO:
    		break;
    	case STATE_INICIADO:
    		this.panelNumJog.setBackground(Color.ORANGE);
    	}

//    	this.lbNomeSala.setOpaque(false);
    	this.updateUI();
	...
	public void jogEntraSala() {
		numJogadores += 1;
		this.lbNumJog.setText(numJogadores.toString());
	}

	public void jogSaiuDaSala(){
		numJogadores += -1;
		this.lbNumJog.setText(numJogadores.toString());		
	}

	public void salaComecaJogo() {
