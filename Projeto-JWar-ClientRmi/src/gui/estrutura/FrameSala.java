...
import negocio.logistica.acao.SairSalaCommand;
 ...
 */
public class FrameSala extends javax.swing.JDialog implements ISalaGuiRmi{

	private String nomeSala;
	private String rSala;
    ...
    private void tfMensagemActionPerformed(java.awt.event.ActionEvent evt) {
    	try {
			ClientSession.getSession().getSala().
					escrever(ClientSession.getSession().getSalaName(),
	...
	@Override
	public void alguemEntrou(VJogadorDaSala jogSala) throws RemoteException {
	...
	private void actionSair() {
		Command c = new SairSalaCommand(this.getNomeSala());
		try {
	...
	public String getReferenciaSala() {
		return rSala;
	}

	public void setReferenciaSala(String sala) {
		this.rSala = sala;
	}
