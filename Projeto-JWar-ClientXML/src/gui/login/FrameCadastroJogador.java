 ...
 *
 */
public class FrameCadastroJogador extends JDialog{
    ...
    private void actionBtSalvar(ActionEvent evt) {
    	if(validaCampos()) {
    		changeStatus("Conectando ao servidor");
        		
    		CadastrarCommand c = new CadastrarCommand(tfNomeGuerra.getText(), tfNomeGuerra.getText(),
